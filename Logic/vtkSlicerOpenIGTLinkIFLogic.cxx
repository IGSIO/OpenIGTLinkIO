/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkSlicerOpenIGTLinkIFLogic.cxx,v $
...
//----------------------------------------------------------------------------
void vtkSlicerOpenIGTLinkIFLogic::ProcessMRMLEvents(vtkObject *vtkNotUsed(caller),
...
//#include <vtkMRMLScalarVolumeDisplayNode.h"
//----------------------------------------------------------------------------
void vtkSlicerOpenIGTLinkIFLogic::SetActiveVolumeNode(vtkMRMLVolumeNode *activeNode)
{
...
vtkMRMLVolumeNode* vtkSlicerOpenIGTLinkIFLogic::AddHeaderVolume (const char* filename, const char* volname, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerOpenIGTLinkIFLogic::AddArchetypeScalarVolume (const char* filename, const char* volname, int loadingOptions)
{ 
  int centerImage = 0;
  int labelMap = 0;
  int singleFile = 0;
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerOpenIGTLinkIFLogic::AddArchetypeScalarVolume(
...
// higher bits are reserved for future use
vtkMRMLVolumeNode* vtkSlicerOpenIGTLinkIFLogic::AddArchetypeVolume (const char* filename, const char* volname, int loadingOptions, vtkStringArray *fileList)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeNode* vtkSlicerOpenIGTLinkIFLogic::AddArchetypeVolume(const char* filename, 
                                                                    const char* volname, 
                                                                    int loadingOptions) 
{
...
//----------------------------------------------------------------------------
int vtkSlicerOpenIGTLinkIFLogic::SaveArchetypeVolume(const char* filename, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode *vtkSlicerOpenIGTLinkIFLogic::CreateLabelVolume (vtkMRMLScene *scene, vtkMRMLVolumeNode *volumeNode, const char *name)
{
  if ( volumeNode == 0 ) 
    {
    return 0;
...
//----------------------------------------------------------------------------
int vtkSlicerOpenIGTLinkIFLogic::IsFreeSurferVolume (const char* filename)
{
...
//-------------------------------------------------------------------------
void vtkSlicerOpenIGTLinkIFLogic::ComputeTkRegVox2RASMatrix ( vtkMRMLVolumeNode *VNode,
                                                                       vtkMatrix4x4 *M )
{
    double dC, dS, dR;
    double Nc, Ns, Nr;
...
//-------------------------------------------------------------------------
void vtkSlicerOpenIGTLinkIFLogic::TranslateFreeSurferRegistrationMatrixIntoSlicerRASToRASMatrix( vtkMRMLVolumeNode *V1Node,
